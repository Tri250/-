...
export function HomePage({ onNavigate }: HomePageProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-orange-50/30 relative overflow-hidden">
      <TechParticles className="opacity-50" />
            ...
            <div className="relative">
              <button className="relative p-3 rounded-2xl bg-white/70 hover:bg-white shadow-sm border border-slate-200/50 transition-all duration-300 hover:scale-105 active:scale-95">
                ...
                {healthAlerts.length > 0 && (
                  <>
                    <span className="absolute -top-1 -right-1 w-6 h-6 bg-gradient-to-r from-red-500 to-pink-500 rounded-full flex items-center justify-center text-[10px] text-white font-black shadow-lg shadow-red-400/50 animate-bounce-soft">
                      {healthAlerts.length}
                    </span>
      ...
      <main className="max-w-md mx-auto px-4 py-6 space-y-6 animate-fadeInUp relative z-10">
        ...
        <GlassCard className="space-y-5">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-3 pt-2">
              <div className="text-center p-3 rounded-xl bg-gradient-to-br from-green-50 to-emerald-50 border border-green-100/50">
                <div className="text-2xl font-black text-green-600">+12%</div>
                <div className="text-[10px] font-semibold text-green-700 mt-1">周环比</div>
              </div>
              <div className="text-center p-3 rounded-xl bg-gradient-to-br from-blue-50 to-cyan-50 border border-blue-100/50">
                <div className="text-2xl font-black text-blue-600">7天</div>
                <div className="text-[10px] font-semibold text-blue-700 mt-1">数据周期</div>
              </div>
              <div className="text-center p-3 rounded-xl bg-gradient-to-br from-purple-50 to-pink-50 border border-purple-100/50">
            ...
            <div className="p-4 bg-gradient-to-r from-purple-50 to-pink-50 rounded-2xl border border-purple-100/50">
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <p className="text-sm font-bold text-purple-700 mb-1">守护模式已激活</p>
        ...
        {healthAlerts.length > 0 && (
          <GlassCard className="space-y-4 border-l-4 border-orange-500" glow>
        ...
        <GlassCard className="text-center space-y-5 pt-4 pb-6">
          ...
          <div className="space-y-2">
            <h3 className="text-xl font-black text-slate-800">开启智能健康之旅</h3>
